 ...
 * requires an authenticator_txt object, so syncing to a service that doesn't need authentication
 * typically means creating a stub authenticator_txt like this one.
